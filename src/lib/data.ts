...
export const techStack = [
  { name: "JavaScript", category: "Languages", icon: "JS", level: 88 },
  { name: "TypeScript", category: "Languages", icon: "TS", level: 86 },
  { name: "PHP", category: "Languages", icon: "PHP", level: 84 },
  { name: "Java", category: "Languages", icon: "JV", level: 72 },
  { name: "Golang", category: "Languages", icon: "GO", level: 70 },
  { name: "Python", category: "Languages", icon: "PY", level: 72 },
  { name: "Dart", category: "Languages", icon: "DT", level: 78 },
  { name: "React.js", category: "Frontend", icon: "RE", level: 88 },
  { name: "Next.js", category: "Frontend", icon: "NX", level: 88 },
  { name: "React Native", category: "Frontend", icon: "RN", level: 78 },
  { name: "Vue.js", category: "Frontend", icon: "VU", level: 72 },
  { name: "Tailwind CSS", category: "Frontend", icon: "TW", level: 86 },
  { name: "Bootstrap", category: "Frontend", icon: "BS", level: 78 },
  { name: "Laravel", category: "Frontend", icon: "LV", level: 76 },
  { name: "Node.js", category: "Backend", icon: "ND", level: 84 },
  { name: "Express.js", category: "Backend", icon: "EX", level: 82 },
  { name: "NestJS", category: "Backend", icon: "NS", level: 84 },
  { name: "PHP Native", category: "Backend", icon: "PN", level: 80 },
  { name: "Gin Framework", category: "Backend", icon: "GF", level: 70 },
  { name: "MySQL", category: "Database", icon: "MY", level: 84 },
  { name: "PostgreSQL", category: "Database", icon: "PG", level: 84 },
  { name: "Supabase", category: "Database", icon: "SB", level: 80 },
  { name: "Neon", category: "Database", icon: "NE", level: 74 },
  { name: "MongoDB", category: "Database", icon: "MO", level: 78 },
  { name: "Prisma ORM", category: "Database", icon: "PR", level: 84 },
  { name: "GitHub", category: "Tools", icon: "GH", level: 86 },
  { name: "GitLab", category: "Tools", icon: "GL", level: 78 },
  { name: "ClickUp", category: "Tools", icon: "CU", level: 76 },
  { name: "Trello", category: "Tools", icon: "TR", level: 76 },
  { name: "CI/CD", category: "Tools", icon: "CI", level: 74 },
  { name: "Security Testing", category: "Additional", icon: "ST", level: 78 },
  { name: "Quality Testing", category: "Additional", icon: "QT", level: 78 },
  { name: "WordPress CMS", category: "Additional", icon: "WP", level: 76 },
  { name: "UI Design", category: "Additional", icon: "UI", level: 74 },
  { name: "Prompt Engineering", category: "Additional", icon: "PE", level: 78 },
  {
...
export const projects = [
  {
    ...
    description:
      "Built an enterprise-grade dashboard platform with Next.js and NestJS, designed relational database architecture using PostgreSQL, implemented REST APIs, and performed SAST security testing.",
    tags: [
      "Next.js",
      "TypeScript",
      "NestJS",
  ...
  },
  {
    ...
    description:
      "Developed a CMS platform with modern frontend architecture, API services, and relational database management.",
...
export const stats = [
  ...
  { label: "Professional Roles", value: "3", desc: "Engineering and teaching" },
];
