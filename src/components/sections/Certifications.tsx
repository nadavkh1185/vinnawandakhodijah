      ...
      <div className="mx-auto max-w-6xl">
                  ...
                  <div className="relative flex h-full flex-col">
                    ...
                    <div className="relative flex flex-1 flex-col p-6 sm:p-7">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="mt-5 text-sm leading-7 text-[#BAD3DE]">
                          {certificate.description}
                        </p>
                      </div>

                      <div className="mt-6 grid gap-3 border-t border-[#5797B1]/12 pt-5 sm:grid-cols-2">
        ...
        <div className="mt-16">
          <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-end">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#7FA5B8]">
                Certificate Gallery
              </p>
              ...
              return (
                ...
                >
                  <GlassCard hover className="overflow-hidden">
                    <div className="grid min-h-64 gap-0 sm:grid-cols-[0.95fr_1.05fr]">
                      <button
                        type="button"
                        disabled={!hasImage}
                        onClick={() => hasImage && setPreview(certificate)}
                        className="group/preview relative min-h-56 overflow-hidden bg-[#103145]/55 text-left disabled:cursor-not-allowed"
                      ...
                      >
                        {hasImage ? (
                          ...
                          <div className="flex h-full min-h-56 flex-col items-center justify-center gap-4 p-6 text-center">
                            ...
                            <div>
                              ...
                              <p className="mt-1 text-xs leading-5 text-[#7FA5B8]">
                                Add an image path to enable lightbox preview.
                              </p>
                            </div>
                          </div>
                        )}
                        {hasImage && (
                          <span className="absolute inset-x-4 bottom-4 inline-flex items-center justify-center gap-2 rounded-xl border border-white/15 bg-[#06131d]/70 px-4 py-2 text-xs font-semibold text-white opacity-0 backdrop-blur-md transition-opacity group-hover/preview:opacity-100">
                            <IconEye size={15} />
                            Preview Image
                          </span>
                        )}
                      ...
                      <div className="flex flex-col justify-between p-5">
                        <div>
                          <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-xl border border-[#5797B1]/15 bg-[#5797B1]/10 text-[#D7ECF5]">
                            <IconAward size={19} />
                          </div>
                          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#7FA5B8]">
                            {certificate.year || "Year pending"}
                          </p>
                          <h4 className="mt-2 text-lg font-semibold text-white">
                            {certificate.title}
                          </h4>
                          <p className="mt-2 text-sm leading-6 text-[#BAD3DE]">
                            {certificate.issuer}
                          </p>
                        </div>
                        ...
                        <div className="mt-6 flex flex-wrap gap-2">
                          <button
                            ...
                            disabled={!hasImage}
                            onClick={() => hasImage && setPreview(certificate)}
                            className="inline-flex items-center gap-2 rounded-xl border border-[#5797B1]/18 px-3 py-2 text-xs font-semibold text-[#D7ECF5] transition-colors hover:border-[#5797B1]/35 hover:bg-[#5797B1]/10 disabled:cursor-not-allowed disabled:opacity-45"
                          >
                            <IconEye size={15} />
                            Preview
                          </button>
