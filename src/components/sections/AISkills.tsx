...
import { IconBrain, IconCode, IconRoute, IconSparkles } from '@tabler/icons-react';
    ...
    <section id="ai" className="relative z-10 px-6 py-24 sm:py-28 lg:py-32">
      <div className="mx-auto max-w-6xl">
        <SectionTitle
          ...
          subtitle="A focused view of the areas Vinawanda is interested in growing and applying across real products."
        />
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
          {focusAreas.map((area, i) => {
            ...
            return (
              ...
              >
                <GlassCard hover glow className="h-full min-h-64 p-6" glowColor="rgba(87,151,177,0.14)">
                  ...
                  <p className="mt-3 text-sm leading-7 text-[#BAD3DE]">{area.description}</p>
                </GlassCard>
              </motion.div>
            );
          })}
